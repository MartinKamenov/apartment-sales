function changeLocation(placeId, locationId) {
    ...
    if (placeValue === 'Област Кавала') {
    ...
    } else if (placeValue === 'Област Кавала (Град)') {
        locationArray = ['Агиа Параскеви', 'Агиас Варварас', 'Агиос Атанасиос',
        ...
        locationArray = ['Ано Ставрос', 'Аспровалта', 'Врасна', 'Милиес', 'Неа Врасна', 'Паралия Врасна',
            'Ривиера', 'Сериаки Акти', 'Ставрос', 'Серайки Акти', 'Порто Фино', 'Солун (Център)',
            'Каламариа', 'Аналипси', 'Агиа Триада', 'Неа Крини',
            'Пилеа', 'Рентина'
        ];
